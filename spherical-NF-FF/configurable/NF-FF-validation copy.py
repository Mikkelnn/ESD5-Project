...
ffData_loaded_2D = sum_NF_poles_sqrt(ffData_loaded)

# Normalize plots
ffData_loaded_2D = ffData_loaded_2D / np.max(np.abs(ffData_loaded_2D))
...
selected_data_loaded = select_data_at_angle(ffData_loaded_2D, phi_deg_loaded, phi_select_angle)
...
##############################################################################################################
print("Loaded FF:")
calculate_print_hpbw(selected_data_loaded, theta_deg_center)
