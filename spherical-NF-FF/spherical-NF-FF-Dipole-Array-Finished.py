...
radius_nf = wavelength*6  # Radius in meters for near field (20 cm)

# Parameters
num_dipoles = 5  # Number of dipoles in the array
...
ax2.plot(theta_f + np.pi/2, E_theta_far_mod[0, :], label='E_theta (Far Field, θ=0)', alpha=0.7)
